...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* 4 Color Widgets - Exactly like Visual Softech */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          ...
          color="green"
          subtext="Total Receipts Generated Today"
        />
        <StatCard
          ...
          icon={ArrowUpCircle}
          color="blue"
          subtext="Gate Passes Cleared Today"
        />
        <StatCard
        ...
        <StatCard
          ...
          icon={Box}
          color="orange"
          subtext="Active Stock Currently in Chambers"
        />
      </div>
